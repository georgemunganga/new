...
const Guest = () => {
  return (
    ...
    <>
    <div className="w-full max-w-4xl max-w-6xl px-2 mx-auto mt-6">
    ...
    <h2 className="pt-6 pb-2 text-2xl font-medium">Top articles</h2>
      <div className="grid grid-cols-2 gap-4 pb-10 text-sm">
        ...
        <a href="#" className="font-medium underline ">Find your reservation status as a guest</a>
